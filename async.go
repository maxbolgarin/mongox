...
// It start retrying in case of error for DefaultAsyncRetries times.
// It filters errors and won't retry in case of ErrNotFound, ErrDuplicate and ErrInvalidArgument.
func (ac *AsyncCollection) Upsert(queueKey, taskName string, record any, filter F) {
...
// It start retrying in case of error for DefaultAsyncRetries times.
// It filters errors and won't retry in case of ErrNotFound, ErrDuplicate and ErrInvalidArgument.
func (ac *AsyncCollection) SetFields(queueKey, taskName string, filter F, update map[string]any) {
...
// It start retrying in case of error for DefaultAsyncRetries times.
// It filters errors and won't retry in case of ErrNotFound, ErrDuplicate and ErrInvalidArgument.
func (ac *AsyncCollection) UpdateOne(queueKey, taskName string, filter, update F) {
...
// It start retrying in case of error for DefaultAsyncRetries times.
// It filters errors and won't retry in case of ErrNotFound, ErrDuplicate and ErrInvalidArgument.
func (ac *AsyncCollection) UpdateMany(queueKey, taskName string, filter, update F) {
...
// It start retrying in case of error for DefaultAsyncRetries times.
// It filters errors and won't retry in case of ErrNotFound, ErrDuplicate and ErrInvalidArgument.
func (ac *AsyncCollection) UpdateFromDiff(queueKey, taskName string, filter F, diff any) {
...
// It start retrying in case of error for DefaultAsyncRetries times.
// It filters errors and won't retry in case of ErrNotFound, ErrDuplicate and ErrInvalidArgument.
func (ac *AsyncCollection) DeleteOne(queueKey, taskName string, filter F) {
...
// It start retrying in case of error for DefaultAsyncRetries times.
// It filters errors and won't retry in case of ErrNotFound, ErrDuplicate and ErrInvalidArgument.
func (ac *AsyncCollection) DeleteMany(queueKey, taskName string, filter F) {
